var PREGUNTAS = {
    ...
    tecnico: {
        ...
        preguntas: [
            ...
            { id: 2, categoria: "Legislaci\u00f3n SST", pregunta: "Seg\u00fan la Resoluci\u00f3n 0312 de 2019, \u00bfcada cu\u00e1nto debe realizarse la autoevaluaci\u00f3n de los est\u00e1ndares m\u00ednimos?", opciones: ["Anual", "Semestral", "Trimestral", "Bienal"], correcta: 0 },
            { id: 3, categoria: "Legislaci\u00f3n SST", pregunta: "En la clasificaci\u00f3n de empresa seg\u00fan riesgo, \u00bfqu\u00e9 clase corresponde a construcci\u00f3n de obras civiles?", opciones: ["Clase V (Riesgo Alto)", "Clase III", "Clase I", "Clase IV"], correcta: 0 },
            { id: 4, categoria: "ISO y Normas", pregunta: "\u00bfQu\u00e9 significa el enfoque PHVA en ISO 45001?", opciones: ["Planificar, Hacer, Verificar, Actuar", "Proteger, Hacer, Verificar, Actuar", "Planificar, Honrar, Verificar, Actuar", "Planificar, Hacer, Validar, Aplicar"], correcta: 0 },
            ...
            { id: 6, categoria: "ISO y Normas", pregunta: "En un sistema integrado de gesti\u00f3n, \u00bfqu\u00e9 significa la estructura de Alto Nivel (HLS)?", opciones: ["Estructura com\u00fan de cl\u00e1usulas para ISO 45001, 14001 y 9001", "Normativa de seguridad para trabajos en altura", "Est\u00e1ndar de competencias del personal HSEQ", "Metodolog\u00eda de auditor\u00eda interna"], correcta: 0 },
            { id: 7, categoria: "Gesti\u00f3n de Riesgos", pregunta: "\u00bfCu\u00e1l metodolog\u00eda es m\u00e1s usada para valorar riesgos en SST?", opciones: ["GTC 45", "An\u00e1lisis de Pareto", "M\u00e9todo Delphi", "An\u00e1lisis FODA"], correcta: 0 },
            { id: 8, categoria: "Gesti\u00f3n de Riesgos", pregunta: "En la jerarqu\u00eda de controles, \u00bfcu\u00e1l es el control m\u00e1s efectivo?", opciones: ["Eliminaci\u00f3n del peligro", "Controles administrativos", "Uso de EPP", "Se\u00f1alizaci\u00f3n"], correcta: 0 },
            ...
            { id: 10, categoria: "Investigaci\u00f3n de Incidentes", pregunta: "\u00bfQu\u00e9 m\u00e9todo de investigaci\u00f3n de incidentes busca causas ra\u00edz mediante preguntas iterativas?", opciones: ["Los 5 porqu\u00e9s", "Diagrama de Gantt", "An\u00e1lisis DOFA", "Matriz de Eisenhower"], correcta: 0 },
            { id: 11, categoria: "Investigaci\u00f3n de Incidentes", pregunta: "\u00bfQu\u00e9 plazo tiene el empleador para reportar un accidente de trabajo grave a la ARL?", opciones: ["Dentro de los 2 d\u00edas h\u00e1biles siguientes", "Dentro de los 5 d\u00edas h\u00e1biles siguientes", "Dentro de las 24 horas siguientes", "Dentro de la misma semana"], correcta: 0 },
            { id: 12, categoria: "Investigaci\u00f3n de Incidentes", pregunta: "\u00bfQu\u00e9 herramienta gr\u00e1fica se usa para analizar relaciones causa-efecto en incidentes?", opciones: ["Diagrama de Ishikawa (espina de pescado)", "Diagrama de flujo", "Histograma", "Gr\u00e1fico de control"], correcta: 0 },
            ...
            { id: 14, categoria: "Auditor\u00eda", pregunta: "Como coordinador HSEQ, ante un hallazgo de auditor\u00eda \u00bfqu\u00e9 documento debe emitirse primero?", opciones: ["Plan de acci\u00f3n correctiva con responsables y fechas", "Informe a gerencia general", "Cambio del procedimiento afectado", "Capacitaci\u00f3n masiva al personal"], correcta: 0 },
            { id: 15, categoria: "Emergencias", pregunta: "\u00bfCu\u00e1l es el prop\u00f3sito del Plan de Emergencias en el SG-SST?", opciones: ["Definir acciones para prevenir y responder a situaciones de emergencia", "Asignar presupuesto para brigadas", "Contratar personal de vigilancia", "Definir horarios de evacuaci\u00f3n"], correcta: 0 },
            { id: 16, categoria: "Emergencias", pregunta: "\u00bfQui\u00e9nes conforman el Comit\u00e9 Paritario de Seguridad y Salud en el Trabajo (COPASST)?", opciones: ["Representantes del empleador y de los trabajadores en igual n\u00famero", "Solo representantes del empleador", "Solo el coordinador HSEQ y el gerente", "Los supervisores de cada \u00e1rea"], correcta: 0 },
            ...
            { id: 18, categoria: "Indicadores HSEQ", pregunta: "\u00bfC\u00f3mo se calcula la tasa de accidentalidad seg\u00fan la normativa colombiana?", opciones: ["(N\u00famero de AT / Horas hombre trabajadas) x constante K", "N\u00famero de AT / N\u00famero de trabajadores", "D\u00edas perdidos / Total de trabajadores", "Costos por AT / Ingresos operacionales"], correcta: 0 },
            { id: 19, categoria: "Liderazgo HSEQ", pregunta: "Como coordinador HSEQ, \u00bfcu\u00e1l es la mejor estrategia para lograr compromiso gerencial?", opciones: ["Presentar indicadores y an\u00e1lisis costo-beneficio de la gesti\u00f3n HSEQ", "Reportar todas las no conformidades a la autoridad laboral", "Delegar toda la gesti\u00f3n en los supervisores", "Esperar a que gerencia solicite informaci\u00f3n"], correcta: 0 },
            { id: 20, categoria: "Liderazgo HSEQ", pregunta: "\u00bfQu\u00e9 acci\u00f3n refleja mejor el liderazgo en seguridad de un coordinador HSEQ?", opciones: ["Realizar recorridos peri\u00f3dicos en campo dando ejemplo con el uso de EPP", "Revisar documentos desde la oficina", "Delegar todas las inspecciones en los analistas", "Enviar correos recordatorios de las normas"], correcta: 0 },
            ...
            { id: 22, categoria: "Gesti\u00f3n Documental", pregunta: "\u00bfQu\u00e9 documentos son obligatorios en el SG-SST seg\u00fan la Resoluci\u00f3n 0312?", opciones: ["Pol\u00edtica de SST, matriz de riesgos, plan de trabajo anual y plan de emergencias", "Solo la afiliaci\u00f3n a ARL", "El reglamento de higiene y seguridad industrial", "Los contratos de trabajo del personal"], correcta: 0 },
            { id: 23, categoria: "Mejora Continua", pregunta: "\u00bfQu\u00e9 significa el concepto de mejora continua en un sistema de gesti\u00f3n HSEQ?", opciones: ["Proceso recurrente de optimizaci\u00f3n del desempe\u00f1o en HSEQ", "Cumplir solo lo m\u00ednimo legal requerido", "Cambiar el sistema solo cuando hay un accidente", "Hacer lo mismo cada a\u00f1o sin cambios"], correcta: 0 },
            { id: 24, categoria: "Mejora Continua", pregunta: "\u00bfQu\u00e9 herramienta de an\u00e1lisis permite identificar Fortalezas, Debilidades, Oportunidades y Amenazas del SG-SST?", opciones: ["Matriz DOFA (FODA)", "Diagrama de dispersi\u00f3n", "Gr\u00e1fico de control", "Histograma de frecuencia"], correcta: 0 }
        ]
    }
};
